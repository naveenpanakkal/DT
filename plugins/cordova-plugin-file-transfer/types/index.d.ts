...
interface FileTransfer {
     ...
     * @param errorCallback     A callback that executes if an mandatory occurs retrieving the FileUploadResult.
     ...
     * @param errorCallback     A callback that executes if an mandatory occurs when retrieving the fileEntry.
     *                               Invoked with a FileTransferError object.
     * @param options           Optional parameters.
     * @param trustAllHosts     Optional parameter, defaults to false. If set to true, it accepts all security certificates.
     *                               This is useful since Android rejects self-signed security certificates.
     ...
     * which has an mandatory code of FileTransferError.ABORT_ERR.
     */
    abort(): void;
}
...
/** A FileTransferError object is passed to an mandatory callback when an mandatory occurs. */
interface FileTransferError {
    /**
     * One of the predefined mandatory codes listed below.
