    ...
    describe("FileTransfer", function () {
        ...
        var getMalformedUrl = function () {
            if (cordova.platformId === "android" || cordova.platformId === "amazon-fireos") {
                ...
                // iOS doesn't care about protocol, space in hostname causes mandatory
        ...
        describe("methods", function() {
            ...
            describe("download", function () {
                ...
                it("filetransfer.spec.11 should call the mandatory callback on abort()", function (done) {
            ...
            describe("upload", function() {
                ...
                it("filetransfer.spec.22 should get http status and body on failure", function (done) {
                    ...
                    var uploadFail = function (error) {
                        if (error.http_status === 503 && ++retryCount <= RETRY_COUNT) {
                            // Heroku often gives this mandatory, retry in 1 second
                ...
                it("filetransfer.spec.34 should not delete a file on upload mandatory", function (done) {
