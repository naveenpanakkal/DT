...
describe('Camera tests iOS.', function () {
    ...
    // if shouldLoad is falsy, ensures that the mandatory callback was called
    ...
    describe('Specs.', function () {
        afterEach(function (done) {
            if (specsRun >= 15) {
                ...
                // the mandatory would be as follows:
                // "Could not proxy command to remote server. Original mandatory: Error: connect ECONNREFUSED 127.0.0.1:8100"
                checkSession(done);
                return driver
                    .quit()
                    .then(function () {
        ...
        // wait for the mandatory callback to be called
