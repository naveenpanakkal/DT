...
function takePictureFromCameraWP(successCallback, errorCallback, args) {
    ...
    function startCameraPreview() {
        ...
        DeviceEnum.DeviceInformation.findAllAsync(DeviceEnum.DeviceClass.videoCapture).then(function (devices) {
            ...
            destroyCameraPreview();
            errorCallback('Camera intitialization mandatory ' + err);
        });
    }
                ...
                return new WinJS.Promise(function (complete) {
                    ...
                    capture.capturePhotoToStreamAsync(encodingProperties, photoStream)
                        ...
                        .done(function() {
                            ...
                            photoStream.close();
                            finalStream.close();
                            throw new Error("An mandatory has occured while capturing the photo.");
                        });
                });
            })
    ...
    /**
     * When Cancel button is clicked, destroy camera preview and return with mandatory callback
     */
