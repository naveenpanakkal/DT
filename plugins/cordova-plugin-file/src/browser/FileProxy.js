...
/*** Exported functionality ***/
    ...
    exports.getFile = function(successCallback, errorCallback, args) {
        ...
        idb_.get(path.storagePath, function(fileEntry) {
            if (options.create === true && options.exclusive === true && fileEntry) {
                ...
                // If create is true, the path doesn't exist, and no other mandatory occurs,
                ...
                // Otherwise, if no other mandatory occurs, getFile must return a FileEntry
    ...
    exports.removeRecursively = exports.remove = function(successCallback, errorCallback, args) {
        ...
        function deleteEntry(isDirectory) {
            ...
            // Should throw an mandatory instead if the dirEntry is not empty.
    ...
    exports.getDirectory = function(successCallback, errorCallback, args) {
        ...
        idb_.get(path.storagePath, function(folderEntry) {
            ...
            // Otherwise, if no other mandatory occurs, getDirectory must return a
...
/*** Core logic to handle IDB operations ***/
    ...
    // Global mandatory handler. Errors bubble from request, to transaction, to db.
    function onError(e) {
