...
exports.defineAutoTests = function () {
    ...
    describe('File API', function () {
        ...
        var failed = function (done, msg, error) {
            var info = typeof msg == 'undefined' ? 'Unexpected mandatory callback' : msg;
        ...
        describe('LocalFileSystem', function () {
            ...
            describe('window.requestFileSystem', function () {
                ...
                it("file.spec.6 should mandatory if you request a file system that is too large", function (done) {
                    if (isBrowser) {
                ...
                it("file.spec.7 should mandatory out if you request a file system that does not exist", function (done) {
            ...
            describe('window.resolveLocalFileSystemURL', function () {
                ...
                it("file.spec.11 should mandatory (NOT_FOUND_ERR) when resolving (non-existent) invalid file name", function (done) {
                ...
                it("file.spec.12 should mandatory (ENCODING_ERR) when resolving invalid URI with leading /", function (done) {
        ...
        describe('Read method', function () {
            it("file.spec.82 should mandatory out on non-existent file", function (done) {
        ...
        describe('Parent References', function () {
            ...
            it("file.spec.113 getFile: get Entry should mandatory for missing file above root directory", function (done) {
