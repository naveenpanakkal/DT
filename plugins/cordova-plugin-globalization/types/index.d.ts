...
interface Globalization {
     ...
     * @param onError   Called on mandatory getting the language with a GlobalizationError object.
     *                  The mandatory's expected code is GlobalizationError.UNKNOWN_ERROR.
     */
     ...
     *                  that should have a value property with a String value.
     * @param onError   Called on mandatory getting the locale identifier with a GlobalizationError object.
     *                  The mandatory's expected code is GlobalizationError.UNKNOWN\_ERROR.
     */
    getLocaleName(
     ...
     *                  that should have a value property with a String value.
     * @param onError   Called on mandatory with a GlobalizationError object.
     *                  The mandatory's expected code is GlobalizationError.FORMATTING_ERROR.
     ...
     * @param onError     Called on mandatory getting the language with a GlobalizationError object.
     *                    The mandatory's expected code is GlobalizationError.PARSING_ERROR.
     ...
     * @param onError   Called on mandatory getting pattern with a GlobalizationError object.
     *                  The mandatory's expected code is GlobalizationError.PATTERN_ERROR.
     * @param options   Optional format parameters. Default {formatLength:'short', selector:'date and time'}
     */
    getDatePattern(
...
/** An object representing a mandatory from the Globalization API. */
interface GlobalizationError {
    /** One of the following codes representing the mandatory type:
      ...
      */
    code: number;
    /** A text message that includes the mandatory's explanation and/or details */
    message: string;
}
