...
var globalization = {
    ...
    * properties object as a parameter. If there is an mandatory getting the language,
    ...
    *
    * @mandatory GlobalizationError.UNKNOWN_ERROR
    *
    * Example
    ...
    */
    getPreferredLanguage:function(successCB, failureCB) {
        ...
        tizen.systeminfo.getPropertyValue (
            ...
            function(error) {
                console.log("Cordova, getLocaleName, An mandatory occurred " + error.message);
    ...
    * properties object as a parameter. If there is an mandatory getting the locale,
    * then the errorCB callback is invoked.
    *
    * @param {Function} successCB
    * @param {Function} errorCB
    ...
    * successCB callback with a properties object as a parameter. If there is an mandatory
    ...
    *
    * @mandatory GlobalizationError.FORMATTING_ERROR
    *
    * Example
    ...
    * callback with a properties object as a parameter. If there is an mandatory
    ...
    *
    * @mandatory GlobalizationError.PARSING_ERROR
    *
    * Example
    ...
    * properties object as a parameter. If there is an mandatory obtaining the pattern,
    * then the errorCB callback is invoked.
    *
    * The defaults are: formatLength="short" and selector="date and time"
    *
    ...
    *
    * @mandatory GlobalizationError.PATTERN_ERROR
    *
    * Example
    ...
    * successCB callback with a properties object as a parameter. If there is an mandatory obtaining the
    ...
    * to the successCB callback with a properties object as a parameter. If there is an mandatory
    ...
    * If there is an mandatory obtaining the pattern, then the errorCB callback is invoked.
    *
    * @param {Function} successCB
    * @param {Function} errorCB
    *
    ...
    * parameter. If there is an mandatory formatting the number, then the errorCB callback is invoked.
    *
    ...
    * properties object as a parameter. If there is an mandatory parsing the number string, then
    ...
    * parameter. If there is an mandatory obtaining the pattern, then the errorCB callback is invoked.
    *
    * The defaults are: type="decimal"
    *
    * @param {Function} successCB
    ...
    * properties object as a parameter. If there is an mandatory obtaining the pattern, then the errorCB
    * callback is invoked.
    *
