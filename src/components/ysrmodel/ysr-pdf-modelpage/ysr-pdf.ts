...
import {AlertController, NavParams, ViewController, Navbar, Platform , NavController} from "ionic-angular";
...
@Component({
  selector: 'ysrpdf',
  templateUrl: 'ysr-pdf.html',
  providers: [Utils]
})
export class YsrPdfComponent {
  ...
  constructor(public platform: Platform, public navCtrl: NavController ,params: NavParams, public viewCtrl: ViewController,
